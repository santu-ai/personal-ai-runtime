...
| 方法 | 路径 | 认证 | 摘要 |
|---|---|---|---|
| GET | `/api/approvals/` | auth | List Approvals |
...
| POST | `/api/memory/memories` | auth | Create Memory |
| GET | `/api/memory/memories/grouped` | auth | List Memories Grouped |
| GET | `/api/memory/memories/search` | auth | Search Memories |
...
| GET | `/api/settings/notifications` | auth | Get Notification Settings |
| PUT | `/api/settings/notifications` | auth | Update Notification Settings |
...
| GET | `/api/telemetry/llm-calls` | auth | List Llm Calls |
...
| GET | `/api/telemetry/tool-calls` | auth | List Tool Calls |
...
| 方法 | 路径 | 认证 | 摘要 |
|---|---|---|---|
| GET | `/api/timeline/events` | auth | List Timeline Events |
