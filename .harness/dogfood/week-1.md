...
### 今天的卡点
1. 早安简报今天没有生成
2. 设置页面MCP 服务器栏除了数量增加明细，哪些已连接，哪些不可用，不可用原因等等。已解决
3. 设置页面的修改成点击展开的形式，不要全部暴露出来,页面太长了看着不方便。已解决
4. 在chat中，ai生成内容后我滚动页面，对话还是快速的下移，其实当我滚动后应该就停住，这样体验会好些，能明白我的意思吗。已解决
