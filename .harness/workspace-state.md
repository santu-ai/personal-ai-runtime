...
- 进行中任务 / WIP：会话压缩读窗口 DESC + checkpoint 走 sources 已修；spill / ask_user 未做
...
| 日期 | 改动摘要 | 备注 |
|---|---|---|
| 2026-09-01 | compaction：DESC 扫描最新窗口；checkpoint 识别走 payload.sources，不再靠 `[compacted]` 前缀 | 无 Kernel 改动 |
